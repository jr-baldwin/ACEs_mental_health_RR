---
title: "Main analysis on imputed data - ALSPAC & ABCD"
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
# Clear workspace
rm(ace_cor_alspac_nodiag, adhd, agg_row, aggregate, aggregate_nc,  alcohol, antisocial, anxiety, autism, bipolar,
   depression,  df_forest, df_forest_nc, dom_vi_cataracts, dom_vi_handedness, domestic_violence, logSE, long_results,
   maltr_cataracts, maltr_handedness, maltreatment, nc_results, neg_control_data, neg_control_results, neg_control_se, 
   neg_control_z, OR, p, p_nc, par_crim_cataracts, par_crim_handedness, par_criminal, par_psych_cataracts, 
   par_psych_handedness, par_sep, par_sep_cataracts, par_sep_handedness, par_substance, par_substance_cataracts, 
   par_substance_handedness, parent_psychopathology, results, schizophrenia, se, z)
```
...
```{r parental mental health illness}
# Parental mental illness
...
# Clear workspace
rm(combs, df, est, fit.mi, log_odds_combs, log_odds_diff, 
   p_any, pair_combs, pairwise_Wald, PGS, pgs_ace_model, pgs_comparison,
   pgs_data, pgs_diff, results_pgs, se, se_combs, se_diff, sig)
```
...
# Clear workspace
rm(ace_cor_abcd, ace_cor_alspac, ace_cor_alspac_nodiag,  ace_cor_nodiag_abcd, adjusted, agg_2a, agg_2a_nc,
confound, d_to_r, est, est_model, ext_abcd, externalising, extract_res,          
fit_ext_dom_violence, fit_ext_maltreatment, fit_ext_par_crim, fit_ext_par_psych, fit_ext_par_sep, 
fit_ext_par_substance, fit_int_dom_violence, fit_int_maltreatment, fit_int_par_crim,      
fit_int_par_psych, fit_int_par_sep, fit_int_par_substance, hyp2a_ext_abcd, hyp2a_ext_alsp,       
hyp2a_int_abcd, hyp2a_int_alsp, int_abcd, int_ext_abcd, internalising, lowci_model, 
multi_PGS_model, multi_PGS_model_abcd, nc_ext, nc_ext_dom_violence, nc_ext_maltreatment,
nc_ext_par_crim, nc_ext_par_psych, nc_ext_par_sep, nc_ext_par_substance, nc_int, nc_int_dom_violence, nc_int_maltreatment,   
nc_int_par_crim, nc_int_par_psych, nc_int_par_sep, nc_int_par_substance, NC_PGS_model, numeric_cols, observed_pgs,          observed_pgs_long, prop, se, se_model, se_nc, table_e, table_e_abcd, table_r, table_r_abcd, table_r_alspac, 
total, upci_model, var_d_to_var_r, var_model, xtract_res)
