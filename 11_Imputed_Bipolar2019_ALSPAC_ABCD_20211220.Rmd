---
title: "Robustness analysis using bipolar PGS derived from Stahl et al. (2019)"
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
# Clear workspace
rm(ace_cor_alspac, ace_cor_alspac_nodiag,  adhd, agg_row,
   aggregate, alcohol, all_imputations_alspac, antisocial, anxiety,
   autism, bipolar, depression, domestic_violence, long_results, maltreatment,   p, par_criminal,
   par_sep, par_substance, parent_psychopathology, results, schizophrenia, se, z)
```
...
# Clear workspace
rm(ace_cor_abcd, ace_cor_alspac, ace_cor_alspac_nodiag, ace_cor_nodiag_abcd, adjusted, agg_2a, confound, 
   est_model, ext_abcd, extract_res, fit_ext_dom_violence, fit_ext_maltreatment, fit_ext_par_crim, fit_ext_par_psych,
   fit_ext_par_sep, fit_ext_par_substance, fit_int_dom_violence, fit_int_maltreatment, fit_int_par_crim,
   fit_int_par_psych, fit_int_par_sep, fit_int_par_substance, hyp2a_ext_abcd, hyp2a_ext_alsp, 
   hyp2a_int_abcd, hyp2a_int_alsp, int_abcd, lowci_model, multi_PGS_model, multi_PGS_model_abcd,
   prop, se_model, total, upci_model, var_model)
