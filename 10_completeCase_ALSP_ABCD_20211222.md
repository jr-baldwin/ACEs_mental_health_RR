...
setwd(Data)
# ALSPAC
alspac_CC <- readRDS("completeCases_20210607.rds") 
...
# Apply function to aggregate gsens results
round(agg_res(gsens_ext_alspac, mean_ace_cor_alspac, 4106),4)*100 # 86.72, 73.77-99.67
# Return min and max
